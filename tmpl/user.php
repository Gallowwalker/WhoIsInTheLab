...
<li>
	<div role="user">
		...
		<?php else: ?>
		<a href="<?php echo $user->facebookLink; ?>"><img role="picture" src="<?= $sImgSrc; ?>no-picture.png" height="128" /></a>
		<?php endif; ?>
		<h3 role="name"><?php echo $user->name; ?></h3>
		<ul role="social">
			<?php if ($user->hasTwitter): ?><li role="twitter"><a href="<?php echo $user->twitterLink; ?>"><img src="<?= $sImgSrc; ?>32/twitter.png"/></a></li><?php endif; ?>
			<?php if ($user->hasFacebook): ?><li role="facebook"><a href="<?php echo $user->facebookLink; ?>"><img src="<?= $sImgSrc; ?>32/facebook.png"/></a></li><?php endif; ?>
			<?php if ($user->hasGooglePlus): ?><li role="googlePlus"><a href="<?php echo $user->googlePlusLink; ?>"><img src="<?= $sImgSrc; ?>32/google.png"/></a></li><?php endif; ?>
